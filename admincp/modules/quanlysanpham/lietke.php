<h1 style="padding: 20px 0px;">DANH SÁCH SẢN PHẨM</h1>
<?php
	if(isset($_GET['trang'])){
		$trang=$_GET['trang'];
	}else{
...
<table width="100%" border="1">
  ...
  <tr>  	
    ...
    <td>
      ...
      <a href="index.php?quanly=gallery&ac=lietke&id=<?php echo $dong['idsanpham'] ?>" style="text-align:center;text-decoration:none; font-size:18px;color:#06F;">BST</a>
    </td>
